...
public class RegisterActivityTest {
    ...
    private static final String VALID_PASSWORD_REPEAT = "Testing123!";
    ...
    @Test
    public void CheckBothPasswordsMatchSuccess() {
        boolean valid = false;
        if(VALID_PASSWORD.equals(VALID_PASSWORD_REPEAT)){
            valid = true;
        }
        assertTrue(valid);
    }
    ...
    @Test
    public void CheckBothPasswordsMatchFailure() {
        boolean valid = true;
        if(VALID_PASSWORD.equals(INVALID_PASSWORD)){
            valid = false;
        }
        assertTrue(valid);
    }
